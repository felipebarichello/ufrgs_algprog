...
void Menu_Update() {
	//As funções aqui não funcionam por enquanto - como é óbvio. São só uma indicação do que fazer quando conseguir passar as infos pro level
	...
	if (IsKeyPressed(KEY_Q)) {
		CloseWindow(); //Essa aqui tá pronta
	}
}
